...
public class SpringConfigFile {
	...
	*/
	...
	/* Way 2 to set city (Using SpEL)
	   We can not use SpEL directly inside getter methods instead we can
	   use @Value() annotation as:
	*/
	/*	
	@Bean
	...
	*/
	...
	// Way 3 to set city (Using SpEL and getter method)as:
	@Bean
	public Student stdObj1(@Value("#{addrObj1.getCity()}") String city) {
		Student std = new Student();
		std.setName("Abhinav");
		std.setCity(city);	
		return std;
